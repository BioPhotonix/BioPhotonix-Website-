      ...
      <article className="shell pb-20 pt-32 md:pt-40">
        ...
        <div className="mx-auto mt-14 max-w-2xl">
          {post.body.map((block, i) => {
              ...
              return (
                <ul key={i} className="mt-6 flex flex-col gap-3">
                  {block.items.map((item) => (
                    <li key={item} className="flex items-start gap-3 text-fog/80">
            ...
            return (
              <p key={i} className="mt-6 text-[1.125rem] leading-[1.75] text-fog/80">
                {block.text}
              </p>
            );
          })}
        ...
        <Reveal className="mx-auto mt-16 max-w-2xl border-t border-line pt-10">
          ...
          <p className="mt-3 leading-relaxed text-fog/75">
