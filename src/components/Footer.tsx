        ...
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-6">
            ...
            <div className="mt-6 flex flex-col gap-1.5 text-base">
              ...
              <a href={`mailto:${site.email}`} className="link-underline w-fit break-all text-fog/85 hover:text-fog">
                {site.email}
              </a>
            </div>
          </div>
          ...
          {columns.map((col) => (
            <div key={col.title} className="md:col-span-2">
              ...
              <ul className="mt-4 flex flex-col gap-2.5 text-base">
                {col.links.map((l) => (
                  <li key={l.href}>
                    <Link href={l.href} className="link-underline text-fog/80 hover:text-fog">
                      {l.label}
                    </Link>
                  </li>
                ))}
          ...
          <div className="md:col-span-2">
            ...
            <address className="mt-4 text-base not-italic leading-relaxed text-fog/80">
              {site.address.line1}
              <br />
              {site.address.line2}
              <br />
